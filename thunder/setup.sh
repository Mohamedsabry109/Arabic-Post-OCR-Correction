...
echo ""
echo "  # Sync outputs to HuggingFace (run any time during/after inference):"
echo "  HF_TOKEN=hf_xxx python scripts/hf_sync.py push"
echo "  HF_TOKEN=hf_xxx python scripts/hf_sync.py sync   # pull remote progress first"
echo ""
echo "  # Push Qaari OCR results too:"
echo "  HF_TOKEN=hf_xxx python scripts/hf_sync.py push \\"
echo "      --paths results data/ocr-results/qaari-results"
echo "============================================================"

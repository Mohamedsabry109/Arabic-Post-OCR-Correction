...
\begin{enumerate}
  \item \textbf{Systematic multi-dataset evaluation of augmentation strategies.}
        ...
        This study isolates five conditions (confusion matrix, orthographic rules,
        few-shot examples, morphological post-processing, and self-reflective
        prompting), tests combinations with ablation, and applies DSPy-based
        automated optimisation --- all evaluated across nine datasets (eight
        typewritten fonts and handwritten text) using the same model and
        evaluation protocol.
